 ...
 *
 * <pre>{@code
 * db.url=jdbc:postgresql://host:5432/hub?currentSchema=gym_schema
 * db.username=plugin_gym
 * db.password=<generated>
 * db.schema=gym_schema
 * db.driver-class-name=org.postgresql.Driver
 * }</pre>
 *
 * <p>The role owns {@code gym_schema} and has no grants on {@code hub_schema}
